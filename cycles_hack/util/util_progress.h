...
public:
	...
	void set_cancel_callback(std::function<void(void)> function)
	{
		cancel_cb = function;
	}
	...
	void set_update_callback(std::function<void(void)> function)
	{
		update_cb = function;
	}
...
protected:
	...
	std::function<void(void)> update_cb;
	std::function<void(void)> cancel_cb;
